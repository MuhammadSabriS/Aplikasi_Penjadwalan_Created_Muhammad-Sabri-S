<?php 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $nis_user; ?>" class="form-control" name="nis" placeholder="Masukan NIS" required>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $pendidikan; ?>" class="form-control" name="pendidikan" placeholder="Masukan Pendidikan Terakhir" required>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $alamat_user; ?>" class="form-control" name="alamat" placeholder="Masukan Alamat Karyawan" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="button" onclick="hapusSiswa(<?php echo $id_user; ?>)" class="btn btn-danger" name="">Hapus</button>
      <button type="submit" class="btn btn-success" name="edit_siswa">Simpan</button>
